...
\begin{frame}
    ...
    \end{itemize}
    \vspace*{0.5em}
    \includegraphics[valign=m,width=1em]{pictures/build-icon.png}\hspace*{0.5em} \textbf{MISP Workflow}
    \begin{itemize}
...
% \section{MISP API / PyMISP - Fundamentals}
\begin{frame}
    \frametitle{
        \huge
...
\begin{frame}
    ...
    Currently 17 triggers can be hooked. 3 being \includegraphics[width=3em]{pictures/blocking-workflow.png}.
    \begin{center}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \end{itemize}
        \vspace{0.5em}
        \item[] \hspace*{-2em}\includegraphics[valign=b,width=5em]{pictures/non-blocking-workflow.png} Workflows execution doesn't block the request
        \begin{itemize}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \faIcon{exclamation-triangle} Event data might be partial
        \end{itemize}
...
\begin{frame}
    \frametitle{Fitlering data on which to apply a module}
    \begin{center}
        \includegraphics[width=1.0\textwidth]{pictures/remove-ids-3.png}
    \end{center}
\end{frame}
...
\begin{frame}
    \frametitle{Fitlering data on which to apply a module}
    \begin{center}
        \includegraphics[width=0.45\textwidth]{pictures/remove-ids-3.png}
    \end{center}
    \begin{center}
        \includegraphics[width=0.70\textwidth]{pictures/remove-ids-2.png}
    \end{center}
\end{frame}
...
\begin{frame}[fragile]
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{center}
                \includegraphics[width=1.0\linewidth]{pictures/attribute-json.png}
            \end{center}
        \end{column}
        \begin{column}{0.5\textwidth}
