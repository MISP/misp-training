...
\begin{frame}
    ...
    \vspace*{0.5em}
    \begin{center}
        \frame{\includegraphics[width=0.24\linewidth]{pictures/belgian-joke}}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \textbf{Objectif:} Start with the foundation to understand the basics
    \begin{center}
...
\begin{frame}
    ...
    \textbf{Objectif:} How to install \& configure workflows
    \begin{center}
...
\begin{frame}
    ...
    \textbf{Objectif:} Overview of some common pitfalls
    \begin{center}
...
\begin{frame}
    ...
    \textbf{Objectif:} Overview of Blueprints, Data format and Filtering
\end{frame}
